...
3. Run `npm run check` for validation, build, and tests. It must pass; CI runs the same thing.
...
- Human trial data presented as if it applies to dogs. Cite it as context and label it as such
