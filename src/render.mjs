...
const MARK = `<svg viewBox="0 0 48 48" aria-hidden="true" focusable="false">
  <defs><clipPath id="eh-head"><path d="M24 9.5 C27.5 9.5 30.6 10.4 33 12 L38.5 3.5 L39.5 15.5 C40.6 17.6 41.2 20 41.2 22.6 C41.2 30.5 35 39 28.6 42.4 C27 43.3 25.3 43.8 24 43.8 C22.7 43.8 21 43.3 19.4 42.4 C13 39 6.8 30.5 6.8 22.6 C6.8 20 7.4 17.6 8.5 15.5 L9.5 3.5 L15 12 C17.4 10.4 20.5 9.5 24 9.5 Z"/></clipPath></defs>
  <path d="M24 9.5 C27.5 9.5 30.6 10.4 33 12 L38.5 3.5 L39.5 15.5 C40.6 17.6 41.2 20 41.2 22.6 C41.2 30.5 35 39 28.6 42.4 C27 43.3 25.3 43.8 24 43.8 C22.7 43.8 21 43.3 19.4 42.4 C13 39 6.8 30.5 6.8 22.6 C6.8 20 7.4 17.6 8.5 15.5 L9.5 3.5 L15 12 C17.4 10.4 20.5 9.5 24 9.5 Z" fill="var(--ink)"/>
  <g clip-path="url(#eh-head)">
    <path d="M10.9 7.6 L14.2 11.7 L10.7 13.9 Z" fill="var(--paper)" opacity="0.62"/>
    <path d="M37.1 7.6 L33.8 11.7 L37.3 13.9 Z" fill="var(--paper)" opacity="0.62"/>
    <path d="M24 13 C25.3 16.5 26 21 26.1 25.6 C29.2 27 32.6 29.2 33.9 32.2 C35.2 36.2 31 41.4 26.8 43.4 C25.8 43.9 24.8 44.2 24 44.2 C23.2 44.2 22.2 43.9 21.2 43.4 C17 41.4 12.8 36.2 14.1 32.2 C15.4 29.2 18.8 27 21.9 25.6 C22 21 22.7 16.5 24 13 Z" fill="var(--paper)"/>
    <path d="M13.2 22.8 C14.9 20.2 18.2 19.9 19.8 21.9 C18.6 24.5 15.1 25.1 13.2 22.8 Z" fill="#4aa8dd"/>
    <path d="M34.8 22.8 C33.1 20.2 29.8 19.9 28.2 21.9 C29.4 24.5 32.9 25.1 34.8 22.8 Z" fill="#e0a63f"/>
    <path d="M24 32.6 C25.9 32.6 27.2 33.8 27.2 35.2 C27.2 36.8 25.5 38.1 24 38.9 C22.5 38.1 20.8 36.8 20.8 35.2 C20.8 33.8 22.1 32.6 24 32.6 Z" fill="var(--ink)"/>
  </g>
</svg>`;
...
<link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 48 48%22><defs><clipPath id=%22h%22><path d=%22M24 9.5 C27.5 9.5 30.6 10.4 33 12 L38.5 3.5 L39.5 15.5 C40.6 17.6 41.2 20 41.2 22.6 C41.2 30.5 35 39 28.6 42.4 C27 43.3 25.3 43.8 24 43.8 C22.7 43.8 21 43.3 19.4 42.4 C13 39 6.8 30.5 6.8 22.6 C6.8 20 7.4 17.6 8.5 15.5 L9.5 3.5 L15 12 C17.4 10.4 20.5 9.5 24 9.5 Z%22/></clipPath></defs><path d=%22M24 9.5 C27.5 9.5 30.6 10.4 33 12 L38.5 3.5 L39.5 15.5 C40.6 17.6 41.2 20 41.2 22.6 C41.2 30.5 35 39 28.6 42.4 C27 43.3 25.3 43.8 24 43.8 C22.7 43.8 21 43.3 19.4 42.4 C13 39 6.8 30.5 6.8 22.6 C6.8 20 7.4 17.6 8.5 15.5 L9.5 3.5 L15 12 C17.4 10.4 20.5 9.5 24 9.5 Z%22 fill=%22%23232830%22/><g clip-path=%22url(%23h)%22><path d=%22M24 13 C25.3 16.5 26 21 26.1 25.6 C29.2 27 32.6 29.2 33.9 32.2 C35.2 36.2 31 41.4 26.8 43.4 C25.8 43.9 24.8 44.2 24 44.2 C23.2 44.2 22.2 43.9 21.2 43.4 C17 41.4 12.8 36.2 14.1 32.2 C15.4 29.2 18.8 27 21.9 25.6 C22 21 22.7 16.5 24 13 Z%22 fill=%22%23f7f5f0%22/><path d=%22M13.2 22.8 C14.9 20.2 18.2 19.9 19.8 21.9 C18.6 24.5 15.1 25.1 13.2 22.8 Z%22 fill=%22%234aa8dd%22/><path d=%22M34.8 22.8 C33.1 20.2 29.8 19.9 28.2 21.9 C29.4 24.5 32.9 25.1 34.8 22.8 Z%22 fill=%22%23e0a63f%22/><path d=%22M24 32.6 C25.9 32.6 27.2 33.8 27.2 35.2 C27.2 36.8 25.5 38.1 24 38.9 C22.5 38.1 20.8 36.8 20.8 35.2 C20.8 33.8 22.1 32.6 24 32.6 Z%22 fill=%22%23232830%22/></g></svg>">
</head>
<body>
